...
<CardGroup cols={3}>
  <Card title="Provisioning on AWS" icon="aws" href="/getting-started/provisioning-on-aws">
  </Card>
  <Card title="Provisioning on Google Cloud" icon="google" href="/getting-started/provisioning-on-gcp">
  </Card>
  <Card title="Provisioning on Digital Ocean" icon="digital-ocean" href="/getting-started/provisioning-on-do">
  </Card>
</CardGroup>
