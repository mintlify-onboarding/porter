...
1. Give your user a name and select **Programmatic access**. After selecting **Next**, you will be prompted to set permissions for your user, choose **Attach existing policies directly** and select the **AdministratorAccess** policy:
...
1. After creating the user, you will be shown an **Access key ID** and **Secret access key**. Copy both of these directly into Porter's AWS Credentials form along with your preferred AWS region:
